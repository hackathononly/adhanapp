export default function MainContentFooter() {
  return (
    <div className="dropdown dropdown-top dropdown-end absolute bottom-0 right-2">
      <div tabIndex={0} role="button" className="btn btn-ghost text-sm">
        ...
      </div>
      <ul
        tabIndex={0}
        className="dropdown-content menu p-2 shadow bg-base-200 rounded-box w-48"
      >
        <li className="hidden">
        ...
        <hr className="hidden h-px my-2 bg-gray-200 border-0 dark:bg-gray-700" />
        <li>
          <a href="https://ahmad.build" className="text-right">
            <img
        ...
        <li>
          <a
            href="https://github.com/hackathononly/adhanapp"
